...
In this project, I analyzed financial contributions of about 160,000 individuals
in North Carolina during the 2012 Presidential Election. For each contributor, important information such as his/her city of residence, occupation, candidate recipient, and contribution amount was provided. Using several packages and functions within R, I attempted to explore and manipulate the data in an effort 
to find relationships between the variables and visualize this process.
...
quantile(nc$contb_receipt_amt[which(nc$cand_nm == 'Obama, Barack' &
                                      nc$contb_receipt_amt > 0)])
...
nc.total_by_date <- subset(nc.total_by_date, 
                           contb_receipt_dt < as.Date('2012-11-07'))
